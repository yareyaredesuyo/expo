...
class CameraController(
  ...
  private lateinit var mPreviewTextureView: PreviewTextureView
...
//      TODO()
  ...
  private fun createCameraCaptureSession() {
    try {
      // obtaining surface will block thread until surface is available
      val previewSurface = mPreviewTextureView.getSurface()
  ...
  private fun configureCameraCaptureSession() {
    try {
      ...
      previewRequestBuilder.addTarget(mPreviewTextureView.getSurface())
  ...
  fun setDisplayOrientation(orientationState: OrientationState) {
    ...
    mPreviewTextureView.setOrientation(previewOrientation)
  }
  ...
  fun attachPreview(previewTextureView: PreviewTextureView) {
