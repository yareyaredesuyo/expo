...
async function revertStagingConfigurationAsync() {
...
export default (program: Command) => {
  program
    ...
    .option('--revert', 'Reverts changes on staging to the state from production.', false)
    .asyncAction(action);
};
